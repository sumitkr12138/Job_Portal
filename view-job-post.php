...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index.php" class="logo logo-bg">
      ...
      <span class="logo-lg"><b>Jobopedia</b></span>
    </a>
      ...
      <div class="container">
        <div class="row">          
          <div class="col-md-9 bg-white padding-2">
            ...
            <div>
              <a href="apply1.php?id=<?php echo $row['id_jobpost']; ?>" class="btn btn-success btn-flat margin-top-50">Apply</a>
            </div>
            <?php } ?>
          ...
          <div class="col-md-3">
            <!--div class="thumbnail">
              ...
              <div class="caption text-center">
                ...
                <hr>
                <div class="row">
                  <div class="col-md-4"><a href="apply1.php"><i class="fa fa-address-card-o"></i> Apply</a></div>
  ...
  <footer class="main-footer" style="margin-left: 0px;">
    <div class="text-center">
      <strong>Copyright Ramesh & Shriharsha-2018 <a href="learningfromscratch.online">Jobopedia</a>.</strong> All rights
    reserved.
    </div>
  </footer>
