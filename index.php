  ...
  <body style="background-image: url(image/bg1.jpg);">
    ...
    <section>
      <div class="container-fluid" > 
        <div class="row" >
          <div class="col-md-12" >
            <div class="jumbotron text-center" style="background-image: url(ramesh1.jpg);">
             <!-- <IMG SRC="JBLOGO.png" width=100 height=100 align="left">-->
              <h1 style="font-family:helvetica; color:#800000" >JobP</h1>
              <p style="font-family:helvetica; color:#800000">!!..your future starts now..!!</p>
              <!-- <p><a class="btn btn-primary btn-lg" href="register.php" role="button">Register</a></p> -->
              <p><a class="btn btn-primary btn-lg" href="search.php" role="button">Search Job</a></p><!--search.php-->
            </div>
          </div>
        </div>
      </div>
          ...
          if($result->num_rows > 0) {
            ...
            <div class="attachment-block clearfix">
              ...
              <div class="attachment-pushed">
                <h4 class="attachment-heading"><a href="view-job-post.php?id=<?php echo $row['id_jobpost']; ?>"><?php echo $row['jobtitle']; ?></a> <span class="attachment-heading pull-right">Rs.<?php echo $row['maximumsalary'];?></span></h4>
    ...
    <section>
      <div class="container">
        <div class="row">
           ...
           * returned from database. $result->num_rows will return total number of rows returned from database.
          */
          $sql = "SELECT * FROM company Order By Rand() Limit 4";
          $result = $conn->query($sql);
          if($result->num_rows > 0) {
            while($row = $result->fetch_assoc()) 
            {
            ...
            <div class="col-md-6 fixHeight">             
              ...
              <p><?php echo $row['headofficecity']; ?></p>
...
<footer class="main-footer" style="margin-left:0px;background-color:white;" >
    <div class="text-center" style="padding:27px;margin-left:280px">
      <strong>Copyright sumit-2019 <a href="#">Jobopedia</a>.</strong> All rights
    reserved.   Contact Us:9472897710
