                  ...
                  if($result->num_rows > 0) {
                    while($row = $result->fetch_assoc()) 
                    {
                     ?>
                        ...
                        <h2 style="margin-left:400px;">Welcome <?php echo $row['firstname']; ?></h2><br>
                        <br>
            ...
            <table class="table table-striped">
              ...
              <tbody>
                <?php 
                 ...
                 // $cr7 = "SELECT * FROM company";
                  $result = $conn->query($sql);
                  //$cr7result = $conn->query($cr7);

                  //if there are job posts then display them.
                  if($result->num_rows > 0)/*&&($cr7result->num_rows >0)) */{
                    while($row = $result->fetch_assoc())/*&&($row2 = $cr7result->fetch_assoc()))*/
                    {
...
<footer class="main-footer" style="margin-left:0px;background-color:white;" >
    <div class="text-center" style="padding:27px;margin-left:100px">
