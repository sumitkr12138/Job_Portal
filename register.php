      ...
      <div class="container">
        <div class="row">
          ...
          <h2 class="text-center">Register</h2>
            <form method="post" action="adduser.php" name="myForm" id="myForm">
              <div class="form-group">
                <label for="fname">First Name</label>
                <input type="text" class="form-control" id="fname" name="fname" placeholder="First Name" required="" pattern="^[a-zA-Z][a-zA-Z\.]{1,20}$">
                <span style="color:red">* Please Enter Letters Only</span>
              </div>
              <div class="form-group">
                <label for="lname">Last Name</label>
                <input type="text" class="form-control" id="lname" name="lname" placeholder="Last Name" required="" pattern="^[a-zA-Z][a-zA-Z\.]{1,20}$">
                 <span style="color:red">* Please Enter Letters Only</span>
              </div>
              <div class="form-group">
...
<footer class="main-footer" style="margin-left:0px;background-color:white;" >
    <div class="text-center" style="padding:27px;margin-left:2px;margin-top:200px;">
